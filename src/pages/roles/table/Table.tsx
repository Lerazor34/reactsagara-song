...
import {ListPagination} from '../../../_metronic/helpers/components/ListPaginantion'
...
const Table = () => {
  ...
  return (
    <KTCardBody className='py-4'>
      ...
      <ListPagination useQueryRequest={useQueryRequest} useQueryResponse={useQueryResponse} useQueryResponseLoading={useQueryResponseLoading} />
