...
import { PaginationHelpers } from '../..//helpers/crud-helper/PaginationHelpers'
...
const ListPagination = ({useQueryResponse,useQueryResponseLoading,useQueryRequest}: props) => {
